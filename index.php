            ...
            <div class="row pb-4">
                <div class="col-md-4">
                    <div class="card bg-dark text-white border-radius">
                        <a href="./categories.php" class="text-white"><img src="./access/image/food-img/pizza.jpg"
                ...
                <div class="card mb-3 col-md-6 food-item">
                    <div class="row g-0">
                        <div class="col-lg-4 text-center m-auto">
                            <img src="./access/image/food-img/menu-pizza.jpg" class="img-fluid rounded" alt="...">
                        </div>
                        <div class="col-lg-8 ">
                            <div class="card-body">
